...
\lsptoprule
& \multicolumn{2}{c}{CV} & {CCV} & \multicolumn{2}{c}{CVC}\\\midrule
{/l/} & \multicolumn{2}{c}{--} & {--} & [w] & 77.3\%\\
      &        &                &      &deletion & 6\%\\\tablevspace
{/ʎ/} & [l\textsuperscript{j}] & 42.8\% & {--} & \multicolumn{2}{c}{--}\\
      & [l]                    & 4.8\%\\\tablevspace
